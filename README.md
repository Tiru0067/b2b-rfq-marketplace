...
6. **Smart Bid Highlights**:
   - When a buyer inspects received quotations, the application automatically computes and tags:
     - 🟢 **Lowest Bid** (best price)
...
| **Buyer** | `buyer2@apexlogistics.com` | `password123` | Rohan Mehta (Apex Logistics) |
| **Supplier** | `supplier1@acme.com` | `password123` | Acme Industrial Furnishings |
| **Supplier** | `supplier2@zenith.com` | `password123` | Zenith Commercial Supplies |
...
* `PATCH /api/buyer/rfqs/:id/status` — Toggle RFQ status between `OPEN` and `CLOSED`
...
* `GET /api/supplier/quotations` — View all submitted quotations history
